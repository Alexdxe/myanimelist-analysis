...
## Loading Our Dataset:
```{r}
anime.dataset.2023 <- read.csv("C:/Users/alexd/Downloads/Projects/MyAnimeList Data Analysis/anime-dataset-2023.csv", comment.char="#")
...
### Despite our coefficients not being able to pass all of the necessary conditions needed to perform these tests, let's run a lest for Pearson's coefficent as a "what-if"
...
# **Question 4)** Fit a multiple linear regression model, with variables: Y= Score, B1 = Start_Year, B2 = Type, B3 = members.
Making all models:
...
# **Question 7)** What kind of groups/trends can we observe by clustering Rank, Populuarity, Episodes, and Start Year to Score?
